...
Even so, a software check happens that ensures that on first launch from bootup of the computers that the tilt motor is pressing a limit switch inside the head. 
